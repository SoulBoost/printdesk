...
<?php
    $printer_id = $_GET['id'];
    $printer = mysqli_query($link, "SELECT * FROM regions WHERE id = $printer_id");
...
<?php if(!empty($_SESSION["login"])) : ?>
    ...
    <a type="button" class="btn btn-success" href = "../admin/listprinter.php">К списку принтеров</a>
    ...
    <input type="hidden" name="id" value ="<?=$printer['id'] ?>">
            ...
            <div class="input-group flex-nowrap mt-2">
                ...
                <!-- <div class="input-group mb-3 mt-2">
                    ...
                    <button class="btn btn-success mt-2" type="submit" onclick="alert('Данные обновлены')" href="#">Обновить параметры</button>
                    </div>
                </div>
        </div>
    </div>
