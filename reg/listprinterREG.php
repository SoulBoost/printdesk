        ...
        <div class="table-responsive">
          <table class="table table-striped" id = "info-table">
            ...
            <?php
             ...
             $printers = mysqli_query($link, "SELECT * FROM regions");
...
<div class="btn-group">
  <button type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"><i class="fas fa-pencil-alt"></i></a>
        ...
        <ul class="dropdown-menu">
          <li><a class="dropdown-item" href="edit_reg.php?id=<?= $printer[0] ?>">Редактировать имя/IP</a></li>
	  ...
	  <li><a class="dropdown-item" href="action/delete_reg.php?id=<?= $printer[0] ?>">Удалить</a></li>
        </ul>
</div>
              </td>
            </tr>
